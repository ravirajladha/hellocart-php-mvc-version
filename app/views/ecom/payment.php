...
?>
         ...
         <div class="bg-primary border-bottom px-3 pb-5">

         </div>
         <!-- checkout -->
         <form action="<?php echo URLROOT; ?>/ecom/pay" method="post" autocomplete="off">
         ...
         <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
               <div class="modal-content">
                  ...
                  <form action="<?php echo URLROOT; ?>/ecom/add_address/<?php echo $data['type']; ?>" method="post" autocomplete="off">
