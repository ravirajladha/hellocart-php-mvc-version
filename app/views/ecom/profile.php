...
?>
    <body class="fixed-bottom-bar">
      <div class="kods-home-page">
         ...
         <div class="bg-primary border-bottom pt-3 align-items-center">
         ...
         <div class="p-3 kods-profile">
            ...
            <div class="bg-white rounded shadow mt-3 profile-details">
               ...
               <a href="<?php echo URLROOT; ?>/ecom/orders" class="d-flex w-100 align-items-center border-bottom p-3">
                  <div class="left mr-3">
               ...
               <a href="<?php echo URLROOT; ?>/ecom/all_orders" class="d-flex w-100 align-items-center border-bottom p-3">
               <div class="d-flex align-items-center border-bottom p-3">
                  <div class="left mr-3">
               ...
               <a href="<?php echo URLROOT; ?>/home/tnc" class="d-flex w-100 align-items-center border-bottom px-3 py-4">
                  <div class="left mr-3">
               ...
               <a href="<?php echo URLROOT; ?>/home/privacy_policy" class="d-flex w-100 align-items-center px-3 py-4">
                  <div class="left mr-3">
