...
$vendor= $data['vendor'];
if(!$cart){
   header('Location: '.URLROOT.'/ecom/index');
}
$type = $data['type'];
?>
          ...
          <br>
            <div class="kods-cart-item-profile bg-white rounded shadow p-3 mt-n5">
               <div class="d-flex flex-column">
                  ...
                  <input type="radio" id="delivery" value="0" name="order_type" class="custom-control-input" <?php if(!$type){echo "checked=''";} ?> onclick="javascript:location.href='<?php echo URLROOT; ?>/ecom/checkout'">
            ...
            <div class="kods-cart-item-profile bg-white rounded shadow p-3 mt-n5">
               <div class="d-flex flex-column">
                  ...
                  <input type="radio" id="self_pickup" value="2" name="order_type" class="custom-control-input" <?php if($type){echo "checked=''";} ?> onclick="javascript:location.href='<?php echo URLROOT; ?>/ecom/checkout/1'">
...
if(document.getElementById('delivery').checked) {
   window.location = "<?php echo URLROOT; ?>/ecom/payment/0";
}else if(document.getElementById('self_pickup').checked) {
   window.location = "<?php echo URLROOT; ?>/ecom/payment/2";
}
   }
</script>
