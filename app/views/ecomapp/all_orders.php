   ...
   <body class="fixed-bottom-bar bg-light">
      <div class="kods-profile">
         <div class="bg-primary border-bottom px-3 pt-3 pb-5 d-flex align-items-center">
            ...
            <h4 class="font-weight-bold m-0 text-white">Orders</h4>
         </div>
         <!-- profile -->
         <div class="p-3 kods-profile">
            <div class="bg-white rounded shadow mt-n5">
               <div class="d-flex align-items-center border-bottom p-3">
                  ...
                  <div class="right">
                  <h6 class="mb-1 font-weight-bold">Order List<i class="feather-check-circle text-success"></i></h6>
                     <p class="text-muted m-0 small"><?php echo $_SESSION['rexkod_user_name']; ?></p>
                  </div>
               </div>
             ...
             <div class="kods-card mt-3 bg-white overflow-hidden shadow rounded active">
               <div class="kods-card-header" id="<?php echo $order->id; ?>">
                  <h2 class="mb-0">
                    ...
                    <span class="ml-auto"><?php echo  date("m/d/y, h:m a", strtotime($order->created_at)); ?></span>
                     </button>
                  </h2>
               </div>
                     ...
                     <h6 class="mb-3 mt-0 mb-3 font-weight-bold">Paid <span class="pull-right" style="font-size:12px;"><?php if($order->order_type == 0){ ?>
                        ...
                        <div class="process-row">
                           <div class="process-step">
                                 <img src="<?php echo URLROOT; ?>/assets_ecom/img/a1.jpg" width="50">
                                 <p>Order Placed</p>
                           </div>
                           <div class="process-step">
                           <img src="<?php echo URLROOT; ?>/assets_ecom/img/a2.jpg" width="50" <?php if($order->status<1){echo "style='filter: grayscale(100%)'";}?> >
                                 <p>Preparing</p>
                           </div>
                           <div class="process-step">
                           <img src="<?php echo URLROOT; ?>/assets_ecom/img/a3.jpg" width="50" <?php if($order->status<2){echo "style='filter: grayscale(100%)'";}?>>
                                 <p>Ready</p>
                           </div> 
                              <div class="process-step">
                              <img src="<?php echo URLROOT; ?>/assets_ecom/img/a4.jpg" width="50" <?php if($order->status<3){echo "style='filter: grayscale(100%)'";}?>>
                                 <p>Delivered</p>
                           </div> 
                        </div>
                     </div>
