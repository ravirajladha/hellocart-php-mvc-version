             ...
             <div class="kods-card mt-3 bg-white overflow-hidden shadow rounded active">
                  <div class="kods-card-header" id="<?php echo $order->id; ?>">
                     <h2 class="mb-0">
                        ...
                        <span style='color:#666;margin-right:5px;'> #<?php echo $order->id; ?></span> <?php echo $vendor->vendor_name."<pre> </pre>"; if($order->order_type == 2){echo " <span style='color:#333;font-size:10px;'> (Self Pickup) </span> ";}?> 
               ...
               <?php endif; if(!$rating && $order_count==1):?>
                  <form action="<?php echo URLROOT; ?>/ecomapp/rating/<?php echo $order->id; ?>/<?php echo $order->vendor_id; ?>" method="POST" id="rate<?php echo $order->id;?>" name="rate<?php echo $order->id;?>">
                      <div class="row">
                     <div class="col-md-12">
                     <div class="feedback" style="float:left">
                        <div class="rating">
                           ...
                           <label for="rating-1"></label>
                              ...
                              <div class="col-sm-7"><input type="text" class="form-control" name="review" placeholder="Write a review!"></div><br><br>
