							...
							<div class="col-xl-12 col-lg-6 ">
								<div class="card h-auto">
									<div class="card-body text-center">
										...
										<h4 class="mb-3 text-black font-w600">Ramesh Kumar</h4>
										...
										<div class="table-responsive ">
											<table class="table items-table">
												...
												<tr>
													<td>
														<div class="media">
															<a href="ecom-product-detail.html"><img class="mr-3 img-fluid rounded" width="85" src="./images/dish/pic1.jpg" alt="DexignZone"></a>
													...
													<td>
														<h4 class="my-0 text-secondary font-w600"><i class='fa fa-inr'></i>14.99</h4>
													</td>
													<td>
														<h4 class="my-0 text-secondary font-w600"><i class='fa fa-inr'></i>44.97</h4>
													</td>
													<td>
												...
												<tr>
													<td>
														<div class="media">
															<a href="ecom-product-detail.html"><img class="mr-3 img-fluid rounded" width="85" src="./images/dish/pic2.jpg" alt="DexignZone"></a>
															<div class="media-body">
													...
													<td>
														<h4 class="my-0 text-secondary font-w600"><i class='fa fa-inr'></i>4.12</h4>
													</td>
													<td>
														<h4 class="my-0 text-secondary font-w600"><i class='fa fa-inr'></i>4.12</h4>
													</td>
												...
												<tr>
													<td>
														<div class="media">
															<a href="ecom-product-detail.html"><img class="mr-3 img-fluid rounded" width="85" src="./images/dish/pic3.jpg" alt="DexignZone"></a>
															<div class="media-body">
													...
													<td>
														<h4 class="my-0 text-secondary font-w600"><i class='fa fa-inr'></i>15.44</h4>
													</td>
													<td>
														<h4 class="my-0 text-secondary font-w600"><i class='fa fa-inr'></i>15.44</h4>
													</td>
									...
									<div class="card-body">
										...
										<div class="row mx-0">
											<div class="media align-items-center col-md-4 col-lg-6 px-0 mb-3 mb-md-0">
												...
												<div class="media-body">
													<h4 class="my-0 text-black">Dunzo Delivery</h4>
