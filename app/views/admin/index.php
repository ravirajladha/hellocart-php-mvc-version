			...
			<div class="container-fluid">
                ...
                <div class="row">
				  <div class="col-xl-3 col-xxl-6 col-lg-6 col-md-6 col-sm-6">
							...
							<div class="card-body p-4">
								<div class="media ai-icon">
									...
									<div class="media-body">
										<h3 class="mb-0 text-black"><span class="counter ml-0"><?php echo $data['users']; ?></span></h3>
										<p class="mb-0">Total Customer<span style="font-size:10px;">/ Today</span></p>
						...
						<div class="widget-stat card">
							<div class="card-body p-4">
								<div class="media ai-icon">
									...
									<div class="media-body">
										<h3 class="mb-0 text-black"><i class="fa fa-inr" style="font-size:30px"></i> <span class="counter ml-0"><?php echo $data['revenue']; ?></span></h3>
										<p class="mb-0">Total Revenue<span style="font-size:10px;">/ Today</span></p>
						...
						<div class="widget-stat card">
							<div class="card-body p-4">
								<div class="media ai-icon">
									...
									<div class="media-body">
										<h3 class="mb-0 text-black"><span class="counter ml-0"><?php echo $data['orders']; ?></span></h3>
										<p class="mb-0">Total Orders<span style="font-size:10px;">/ Today</span></p>
					...
					<div class="col-xl-3 col-xxl-6 col-lg-6 col-md-6 col-sm-6">
					<a href="<?php echo URLROOT; ?>/admin/vendors">
						<div class="widget-stat card">
							<div class="card-body p-4">
								<div class="media ai-icon">
									<span class="mr-3 bgl-primary text-primary">
									...
									<div class="media-body">
										<h3 class="mb-0 text-black"><span class="counter ml-0"><?php echo $data['vendors']; ?></span></h3>
										<p class="mb-0">Total Restaurants<span style="font-size:10px;">/ All</span></p>
							...
							<div class="card-body tab-content orders-summary pt-3">
								<div class="tab-pane fade show active" id="Monthly">
									<div class="d-flex flex-wrap order-manage p-3 align-items-center mb-4">
										<a href="javascript:void(0);" class="btn fs-22 py-1 btn-success px-4 mr-3"><?php echo $data['live']; ?></a>
										<h4 class="mb-0">Live Orders <i class="fa fa-circle text-success ml-1 fs-15"></i></h4>
										
									</div>
									<div class="row">
										<div class="col-sm-4 mb-4">
											<div class="border px-3 py-3 rounded-xl">
												<h2 class="fs-32 font-w600 counter"><?php echo $data['delivery']; ?></h2>
												<p class="fs-16 mb-0">Delivery<span style="font-size:10px;"> / Today</span></p>
											</div>
										</div>
										<div class="col-sm-4 mb-4">
											<div class="border px-3 py-3 rounded-xl">
												<h2 class="fs-32 font-w600 counter"><?php echo $data['pickup']; ?></h2>
												<p class="fs-16 mb-0">Self Pickups<span style="font-size:10px;"> / Today</span></p>
											</div>
										</div>
										<div class="col-sm-4 mb-4">
											<div class="border px-3 py-3 rounded-xl">
												<h2 class="fs-32 font-w600 counter"><?php echo $data['dine']; ?></h2>
												<p class="fs-16 mb-0">Dine In<span style="font-size:10px;"> / Today</span></p>
											</div>
										</div>
									</div>
    ...
    border-radius: 12px;
					...
					<div class="col-xl-12 col-xxl-12 col-lg-12 col-md-12">
						<div class="crd">
							...
							<div class="card-body tab-content orders-summary">
								<div class="tab-pan fade show acive row">
									<div class="col-lg-5 d-flex flex-wrap order-manage or2 p-3 align-items-center mb-4">
										<a href="javascript:void(0);" style="background:#ffa342;border-color:#ffa342;" class="btn fs-22 py-1 btn-success px-4 mr-3"><?php echo $data['ecom_count']->pc_val; ?></a>
										<h4 class="mb-0">Ecom Visitors</h4>
										
									</div>
									<div class="col-md-1"></div>
									<div class="col-lg-5 d-flex flex-wrap order-manage or2 p-3 align-items-center mb-4">
										<a href="javascript:void(0);" style="background:#ffa342;border-color:#ffa342;" class="btn fs-22 py-1 btn-success px-4 mr-3"><?php echo $data['home_count']->pc_val; ?></a>
										<h4 class="mb-0">Home Visitors </h4>
