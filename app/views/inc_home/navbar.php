							...
							<div class="navbar navbar-default" role="navigation">
								<div class="contaier-fluid">
									...
									<div class="navbar-header">
										...
										<img src="<?php echo URLROOT ?>/assets4/img/logo/logo.png" alt="logo" width="200" style="margin-top:10px;">
									</div><!-- /.navbar-header -->
									...
									<nav class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
										<ul id="main-nav" class="nav navbar-nav">
											...
											<li><a href="https://blog.hellowcart.in" target="_BLANK">Blog</a></li>
											<li><a href="<?php echo URLROOT; ?>/ecom">Shop</a></li>
