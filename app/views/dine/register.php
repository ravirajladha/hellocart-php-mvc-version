                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <form action="<?php echo URLROOT; ?>/dine/user_register/<?php echo $data['table_id']; ?>" method="post" autocomplete="off">
                                    ...
                                    <a href="<?php echo URLROOT; ?>/dine/login/<?php echo $data['table_id']; ?>"><center><p><br>Already have an account? Sign In.</p></center></a>
