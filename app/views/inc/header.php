<!DOCTYPE php>
<php lang="en">
<?php if(!isset($_SESSION['rexkod_vendor_id'])){
				...
				<div class="main-bar clearfix ">
					<div class="container-fluid clearfix">
						...
						<div class="logo-header mostion logo-dark">
							<a href="index.php"><img src="<?php echo URLROOT; ?>/assets/images/logo2.png" alt="" style="width:150px !important"></a>
							...
							<div class="extra-cell">
								<a href="javascript:void();" class="profile-box">
									<div class="header-info">
										<span><?php echo $_SESSION['rexkod_vendor_name'] ;?></span>
										<small><?php if($_SESSION['rexkod_staff_id']){echo $_SESSION['rexkod_staff_type'];}else {echo "Restaurant Admin";} ?></small>
									</div>
									<div class="img-bx">
										<img src="<?php echo URLROOT; ?>/uploads/<?php echo $_SESSION['rexkod_vendor_img']; ?>" alt="">
									</div>
								</a>
							</div>
													</div>
						...
						<div class="header-nav navbar-collapse collapse" id="navbarNavDropdown">
							<div class="logo-header">
								<img src="<?php echo URLROOT; ?>/assets2/images/avatar/1.jpg" alt="">
							</div>
							<ul class="nav navbar-nav navbar navbar-left" style="float:right !important">	
<?php if($_SESSION['rexkod_staff_type'] =="admin" || $_SESSION['rexkod_staff_type'] =="manager" || $_SESSION['rexkod_staff_type'] =="cashier") { ?>							
								<li class=""><a href="<?php echo URLROOT; ?>/pages/payments">
...
<?php } if($_SESSION['rexkod_staff_type'] =="admin" || $_SESSION['rexkod_staff_type'] =="manager" || $_SESSION['rexkod_staff_type'] =="supervisor") { ?>
								<li class=""><a href="<?php echo URLROOT; ?>/pages/orders">
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										<rect x="0" y="0" width="24" height="24"/>
								...
								<li class=""><a href="<?php echo URLROOT; ?>/pages/live">
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										<rect x="0" y="0" width="24" height="24"/>
										<path d="M4,9.67471899 L10.880262,13.6470401 C10.9543486,13.689814 11.0320333,13.7207107 11.1111111,13.740321 L11.1111111,21.4444444 L4.49070127,17.526473 C4.18655139,17.3464765 4,17.0193034 4,16.6658832 L4,9.67471899 Z M20,9.56911707 L20,16.6658832 C20,17.0193034 19.8134486,17.3464765 19.5092987,17.526473 L12.8888889,21.4444444 L12.8888889,13.6728275 C12.9050191,13.6647696 12.9210067,13.6561758 12.9368301,13.6470401 L20,9.56911707 Z" fill="#000000"/>
...
<style>
  ...
  .content-wrapper {
    padding-top: 125px; } }
					...
					<div class="card-action card-tabs mt-sm-0 fix-mobile" >
									<ul class="nav nav-tabs" role="tablist">
										<li class="nav-item">
											<a class="nav-link active" href="<?php echo URLROOT; ?>/pages/payments" role="tab">
												Payments
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="<?php echo URLROOT; ?>/pages/orders" role="tab">
												New Orders
											</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" href="<?php echo URLROOT; ?>/pages/live" role="tab">
												Live Orders
											</a>
										</li>
		...
		<div class="menu-sidebar">
			<div class="contact-box">
				...
				<ul>
					...
					<?php if($_SESSION['rexkod_staff_type'] =="admin" || $_SESSION['rexkod_staff_type'] =="manager") { ?>
					<li class="nav-item">
					...
					<li class="nav-item">
                        <a class="nav-link" href="<?php echo URLROOT; ?>/pages/settlements">
						<i class="fa fa-inr" style="color:blue"></i> 
						Settlements</a>
                    </li>
					<?php } if($_SESSION['rexkod_staff_type'] =="admin") { ?>
					<li class="nav-item">
                        <a class="nav-link" href="<?php echo URLROOT; ?>/pages/staff">
						<i style="color:#2f4cdd;" class='fa fa-users'></i>
						Staff</a>
                    </li>
					<li class="nav-item">
                        <a class="nav-link" href="<?php echo URLROOT; ?>/pages/coupons">
						<i style="color:#2f4cdd;" class='fa fa-gift'></i>
						Coupons</a>
                    </li>

					<?php } if($_SESSION['rexkod_staff_type'] =="admin" || $_SESSION['rexkod_staff_type'] =="cashier" || $_SESSION['rexkod_staff_type'] =="manager") { ?>

					<li class="nav-item">
                        <a class="nav-link" href="<?php echo URLROOT; ?>/pages/reports">
						<i style="color:#2f4cdd;" class='fa fa-file-text'></i>
						Reports</a>
                    </li>
					<?php } if($_SESSION['rexkod_staff_type'] =="admin" || $_SESSION['rexkod_staff_type'] =="supervisor") { ?>
					<li class="nav-item">
                        <a class="nav-link" href="<?php echo URLROOT; ?>/pages/menu">
						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
							<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								<rect x="0" y="0" width="24" height="24"/>
					...
					<?php } if($_SESSION['rexkod_staff_type'] =="admin" || $_SESSION['rexkod_staff_type'] =="supervisor") { ?>
					<li class="nav-item">
                        <a class="nav-link" href="<?php echo URLROOT; ?>/pages/category">
						<i class="fa fa-list" style="color:blue"></i>
						Categories</a>
                    </li>
					<?php } if($_SESSION['rexkod_staff_type'] =="admin" || $_SESSION['rexkod_staff_type'] =="supervisor") { ?>
					<li class="nav-item">
                        <a class="nav-link" href="<?php echo URLROOT; ?>/pages/tables">
						<i class="fa fa-table" style="color:blue"></i>
						Tables</a>
                    </li>
					<?php } if($_SESSION['rexkod_staff_type'] =="admin" || $_SESSION['rexkod_staff_type'] =="manager") { ?>
					<li class="nav-item">
                        <a class="nav-link" href="<?php echo URLROOT; ?>/pages/reviews">
						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
							<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								<polygon points="0 0 24 0 24 24 0 24"/>
					...
					<?php } if($_SESSION['rexkod_staff_type'] =="admin" || $_SESSION['rexkod_staff_type'] =="cashier" || $_SESSION['rexkod_staff_type'] =="supervisor" || $_SESSION['rexkod_staff_type'] =="manager") { ?>
					<li class="nav-item">
                        <a class="nav-link" href="<?php echo URLROOT; ?>/pages/completed_orders">
						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
							<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								<rect x="0" y="0" width="24" height="24"/>
								<path d="M5.5,4 L9.5,4 C10.3284271,4 11,4.67157288 11,5.5 L11,6.5 C11,7.32842712 10.3284271,8 9.5,8 L5.5,8 C4.67157288,8 4,7.32842712 4,6.5 L4,5.5 C4,4.67157288 4.67157288,4 5.5,4 Z M14.5,16 L18.5,16 C19.3284271,16 20,16.6715729 20,17.5 L20,18.5 C20,19.3284271 19.3284271,20 18.5,20 L14.5,20 C13.6715729,20 13,19.3284271 13,18.5 L13,17.5 C13,16.6715729 13.6715729,16 14.5,16 Z" fill="#000000"/>
					...
					<?php } if($_SESSION['rexkod_staff_type'] =="admin" || $_SESSION['rexkod_staff_type'] =="cashier" || $_SESSION['rexkod_staff_type'] =="supervisor" || $_SESSION['rexkod_staff_type'] =="manager") { ?>
					<li class="nav-item">
                        <a class="nav-link" href="<?php echo URLROOT; ?>/pages/cancelled_orders">
						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
							<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								<rect x="0" y="0" width="24" height="24"/>
								<path d="M5.5,4 L9.5,4 C10.3284271,4 11,4.67157288 11,5.5 L11,6.5 C11,7.32842712 10.3284271,8 9.5,8 L5.5,8 C4.67157288,8 4,7.32842712 4,6.5 L4,5.5 C4,4.67157288 4.67157288,4 5.5,4 Z M14.5,16 L18.5,16 C19.3284271,16 20,16.6715729 20,17.5 L20,18.5 C20,19.3284271 19.3284271,20 18.5,20 L14.5,20 C13.6715729,20 13,19.3284271 13,18.5 L13,17.5 C13,16.6715729 13.6715729,16 14.5,16 Z" fill="#000000"/>
					...
					<?php } if($_SESSION['rexkod_staff_type'] =="admin") { ?>
					<li class="nav-item">
                        <a class="nav-link" href="<?php echo URLROOT; ?>/pages/settings">
						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
							<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								<rect x="0" y="0" width="24" height="24"/>
					...
					<?php } ?>
					<li class="nav-item">
                        <a class="nav-link" href="<?php echo URLROOT; ?>/admin/logout">
						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
							<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								<rect x="0" y="0" width="24" height="24"/>
